        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <button class="btn btn-info" id="openBtn" data-dismiss="modal">Isi saldo rekening anda</button>
                    <button class="btn btn-danger" id="openBtn2" data-dismiss="modal" style="margin-top: 4px;">Cairkan ke saldo dompet</button fitur ini tidak digunakan>
                </div>
